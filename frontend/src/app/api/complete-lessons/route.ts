import { completeCourseLessons } from "@/lib/automator";
...
export async function POST(request: Request) {
  ...
  await completeCourseLessons(cookie, courseId);
  return Response.json({ success: true, message: "Lessons marked completed." });
}
